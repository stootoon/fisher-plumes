...
def plot_correlations(rho,
    ...
    if plot_overlay:
        ...
        plot_legend and plt.legend(frameon=False, fontsize=8, **legend_args)
        plt.xlabel("Distance (p)")        
...
def plot_length_constants_vs_frequency(data, which_ds, which_probe,
                                       names  = defaultdict(lambda: "Surrogate data",
                                                            {"s=p":"Surrogate data", "bw.1_3": "Sims (1_3)", "bw_45":"Sims (45 deg)", "bw_X":"Sims (streamwise)", "bw":"Simulations", "16Ts":"Supplementary", "16Ts_X":"Supplementary (X)", "16Ts_45":"Supplementary (45 deg)"}),
...
def plot_information_regression(data, which_ds, iprb,
                                ...
                                same_plot       = True,
                                coef_plot_width = 2,
                                names    = defaultdict(lambda: "Surrogate data", {"s=p":"Surrogate data", "bw":"Simulations", "bw.1_3":"Simulations (1_3)", "bw_X":"Sims (streamwise)", "bw_45":"Sims (45 deg)", "16Ts":"Supplementary", "16Ts_X":"Supplementary (X)", "16Ts_45":"Supplementary (45 deg)"}),
                                cols     = defaultdict(lambda: cm.gray(0.6), {"s=p":cm.gray(0.4), "bw":cm.GnBu(0.75),"bw.1_3":cm.GnBu(0.75),"bw_X":cm.GnBu(0.75), "bw_45":cm.GnBu(0.75), "16Ts":cm.GnBu(0.35), "16Ts_X":cm.GnBu(0.25), "16Ts_45":cm.GnBu(0.2)}),                                
                                figsize  = None,
                                plot_ils = False,
                                do_label = True,
                                yl = (-0.05, 0.05),
